...
export async function renderCanvas(
  ...
  switch (kind) {
    ...
    case "vta":
      return renderVTA(
        id,
        config as VTAConfig | undefined,
        options
      );
    case "lab-launcher":
      return renderLabLauncher(
        id,
        config as LabLauncherConfig | undefined,
        options
      );
    case "vta-preview":
...
async function renderLabLauncher(
  id: string,
...
async function renderVTAPreview(
  id: string,
